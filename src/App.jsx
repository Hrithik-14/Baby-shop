...
import ProfileDetail from "./Admin/ProfileDetails.jsx"; // Corrected import path
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/profile/:id" element={<ProfileDetail />} /> {/* Moved out of admin */}
        ...
        <Route element={<ProtectedRoute allowedRoles={["admin"]} />}>
          ...
          <Route path="/admin/profile/:id" element={<ProfileDetail />} /> {/* Admin only */}
